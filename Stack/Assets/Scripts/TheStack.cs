...
public class TheStack : MonoBehaviour
{
    ...
    private const float STACK_MOVIE_SPEED = 5.0f;
    ...
    void Update()
    {
        ...
        // Move the stack 
        transform.position = Vector3.Lerp(transform.position, desiredPosition, STACK_MOVIE_SPEED * Time.deltaTime);
    ...
    {
        this.interstitialAd = new InterstitialAd("206422780049976_243870529638534");
